...
const index = () => {
	return (
		<>
			<AppSEO title="Terms and Conditions" />
			<div>
				<SiteInfo title="Terms and conditions">
					<p>
						OVERVIEW
						<br />
						<br />
						This website is operated by Online Bakehouse. Throughout
						the site, the terms “we”, “us” and “our” refer to Online
						Bakehouse.&nbsp;Online Bakehouse&nbsp;offers this
						...
						<br />
						In no case shall InTheBrickYard, our directors,
						...
						your use of the service or any product, including, but
						not limited to, any errors or omissions in any content,
						or any loss or damage of any kind incurred as a result
						of the use of the service or any content (or product)
						...
						InTheBrickYard and our parent, subsidiaries, affiliates,
						...
						us at Hello@Onlinebakehouse.com.
					</p>
				</SiteInfo>
			</div>
		</>
